...
result2 = divide(multiply(nr1, subtract(nr4, nr3)), add(nr2, nr3))
test('expression-3', result1, result2)

result1 = (nr4 - (nr1 * (nr4 - nr3)) / (nr2 + nr3)) 
result2 = subtract(nr4, divide(multiply(nr1, subtract(nr4, nr3)), add(nr2, nr3)))
test('expression-4', result1, result2)

result1 = ((nr4 - (nr1 * (nr4 - nr3)) / (nr2 + nr3)) * 23) - 1
result2 = subtract(multiply(subtract(nr4, divide(multiply(nr1, subtract(nr4, nr3)), add(nr2, nr3))), 23), 1)
