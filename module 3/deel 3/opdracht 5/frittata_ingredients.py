...
GRAM_SALT = ML_TEASPOON * GRAM_PER_ML_SALT
GRAM_PEPPER = ML_TEASPOON * GRAM_PER_ML_PEPPER
GRAM_SPINAZE = ML_CUP * GRAM_PER_ML_SPINACH
GRAM_CHEESE = ML_CUP * GRAM_PER_ML_CHEESE
